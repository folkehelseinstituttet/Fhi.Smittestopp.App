...
#endif
        public static readonly string BASE_URL = "https://test-be-op.ss2np.fhi.no/api/";
        public static string AUTHORIZATION_HEADER => "24jRFidazK";
        public static string USER_AGENT_HEADER => "Smittestopp";
