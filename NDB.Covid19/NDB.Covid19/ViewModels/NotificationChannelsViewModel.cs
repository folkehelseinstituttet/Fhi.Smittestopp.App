...
namespace NDB.Covid19.ViewModels
{
    public class NotificationChannelsViewModel
    {
        ...
        public static string NOTIFICATION_CHANNEL_COUNTER_NAME => "NOTIFICATION_CHANNEL_COUNTER_NAME".Translate();
        public static string NOTIFICATION_CHANNEL_COUNTER_DESCRIPTION => "NOTIFICATION_CHANNEL_COUNTER_DESCRIPTION".Translate();
    }
}
